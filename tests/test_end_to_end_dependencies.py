...
def test_end_to_end_with_dependencies():
    ...
    cmd = [
        ...
        "--entrypoint", "main.lua",
        "--dependencies", '[{"name": "test-lib", "type": "local", "source": "external_deps/test_lib.lua", "license": "external_deps/LICENSE", "description": "Small test library for integration testing"}]'
    ]
    ...
    assert dep_start < namespace_start < main_start, f"Incorrect order: dep={dep_start}, ns={namespace_start}, main={main_start}"
